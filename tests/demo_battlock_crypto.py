...
def run_demo():
    ...
    print("Certificate Valid:", verify_certificate(certificate, root_ca.public_key))
    ...
    print("Counter 1:", replay_guard.validate(1))

    print("Counter 2:", replay_guard.validate(2))

    print("Replay Counter 1:", replay_guard.validate(1))
